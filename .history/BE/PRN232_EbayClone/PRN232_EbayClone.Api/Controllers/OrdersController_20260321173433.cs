...
public class OrdersController : ApiController
{
    ...
    [HttpPost("returns/{returnRequestId:guid}/refund")]
    public async Task<IActionResult> CompleteReturnRefund(
        Guid returnRequestId,
        [FromBody] CompleteReturnRefundRequest request,
        CancellationToken cancellationToken)
    {
        var unauthorizedResult = TryGetAuthenticatedSeller(out var sellerId);
        if (unauthorizedResult is not null)
        ...
        var command = new CompleteReturnRefundCommand(
            returnRequestId,
            sellerId,
