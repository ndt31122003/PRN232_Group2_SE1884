...
public sealed class PerformanceController : ApiController
{
    ...
    public async Task<IActionResult> GetSummaryAsync([FromQuery] string? period, CancellationToken cancellationToken)
    {
        ...
        var query = new GetPerformanceSummaryQuery(Guid.Parse("70000000-0000-0000-0000-000000000001"), period);
    ...
    public async Task<IActionResult> GetSalesReportAsync([FromQuery] string? period, [FromQuery] string? compare, CancellationToken cancellationToken)
    {
        ...
        var query = new GetPerformanceSalesReportQuery(Guid.Parse("70000000-0000-0000-0000-000000000001"), period, compare);
        return await SendAsync(query, cancellationToken);
    }
    ...
    public async Task<IActionResult> GetTrafficAsync([FromQuery] string? period, CancellationToken cancellationToken)
    {
        ...
        var query = new GetPerformanceTrafficQuery(Guid.Parse("70000000-0000-0000-0000-000000000001"), period);
        return await SendAsync(query, cancellationToken);
    }
    ...
    public async Task<IActionResult> GetSellerLevelAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var query = new GetPerformanceSellerLevelDetailsQuery(Guid.Parse("70000000-0000-0000-0000-000000000001"));
            return await SendAsync(query, cancellationToken);
        }
        catch (Exception ex)
        {
    ...
    public async Task<IActionResult> GetServiceMetricsAsync([FromQuery] string? period, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var query = new GetPerformanceServiceMetricsQuery(Guid.Parse("70000000-0000-0000-0000-000000000001"), period);
            return await SendAsync(query, cancellationToken);
        }
        catch (Exception ex)
        {
    ...
    {
        // For testing, use demo seller
        var query = new CheckSellerStandardsWarningQuery(Guid.Parse("70000000-0000-0000-0000-000000000001"));
